...
export default function ProfileColumn({ activeSection }: ProfileColumnProps) {
  const tags = tagsBySection[activeSection] || tagsBySection.home;
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Social Links - Vertical, Centered */}
      ...
      <div className="flex flex-col mt-auto">
        {tags.map((tag) => (
          <span
            key={tag}
            className="text-xl font-medium text-primary-900 tracking-tight py-2 border-b border-gray-200"
          >
            {tag}
          </span>
        ))}
